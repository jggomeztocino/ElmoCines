...
function newColumn(rowID, nColumna) {
    ...
    const column = document.createElement('div'); // Corregido para crear el elemento div
...
function loadBillboard() {
    fetch('/billboard')
        ...
        .catch(error => {
            mensajeError('Error al cargar la cartelera', error);
        });
}
